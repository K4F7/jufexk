...
体育课名 × 老师 10 对 / 64 条是本批之后的独立后续，见 [pe-course-teacher-handoff.md](./pe-course-teacher-handoff.md) 与 [ADR-0018](./adr/0018-pe-course-name-teacher-binding.md)。不要把那 64 条混进下面的 164 / 120 / 12，也不要重放本批。
...
上表是 #111 当时对 419 条的冻结分区。其中后来按课名 × 老师重审并已独立写入的体育记录，见 [pe-course-teacher-handoff.md](./pe-course-teacher-handoff.md)；不要按上表「保持隔离」再导入那 10 对。
